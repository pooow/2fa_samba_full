...
Информация о преобразовании к окончательному варианту методики
```
bk@lin911 2fa_samba_full $ sed -r -f obsidian_to_adoc.sed <obs.adoc >final.adoc
bk@lin911 2fa_samba_full $ asciidoctor-pdf -a pdf-theme=adoc-basic-theme.yml final.adoc
bk@lin911 2fa_samba_full $ tar cvfJ samba_1.0_tar.xz final.adoc jc_* rt_* es_* adoc-basic-theme.yml
```
[[ansible log sed]]
...
WARNING: `bk@lin911 ~ $ ssh root@10.33.33.2 qm rollback 106 snap007 && ssh root@10.33.33.2 qm start 106`

WARNING: `bk@lin911 ~ $ ssh root@10.33.33.2 qm rollback 107 snap007 && ssh root@10.33.33.2 qm start 107`
...
WARNING: pve9 ~ # qm snapshot 106 snap071 --description "2fa_smb.md=obs.ad; sp8-ws-2022.test5.alt add to AD"

WARNING: pve9 ~ # qm snapshot 107 snap071 --description "2fa_smb.md=obs.ad; sp8-ws-2022.test5.alt add to AD"
...
WARNING: pve9 ~ # qm snapshot 106 snap072 --description "2fa_smb.md=obs.ad; PC/SC - OK"

WARNING: pve9 ~ # qm snapshot 107 snap072 --description "2fa_smb.md=obs.ad; PC/SC - OK"
...
WARNING: qm snapshot 106 snap073 --description "2fa_smb.md=obs.ad; PKCS11,p11-kit-proxy.so - OK"

WARNING: qm snapshot 107 snap073 --description "2fa_smb.md=obs.ad; PKCS11,p11-kit-proxy.so - OK"
...
WARNING: pve9 ~ # qm snapshot 106 snap074 --description "2fa_smb.md=obs.ad; DC готов - OK"

WARNING: pve9 ~ # qm snapshot 107 snap074 --description "2fa_smb.md=obs.ad; DC готов - OK"
...
WARNING: qm snapshot 106 snap075 --description "2fa_smb.md=obs.ad; sssd p11_child - OK"

WARNING: qm snapshot 107 snap075 --description "2fa_smb.md=obs.ad; sssd p11_child - OK"
...
WARNING: qm snapshot 106 snap076 --description "2fa_smb.md=obs.ad; 2fa console - OK"

WARNING: qm snapshot 107 snap076 --description "2fa_smb.md=obs.ad; 2fa console - OK"
...
WARNING: qm snapshot 106 snap077 --description "2fa_smb.md=obs.ad; 2fa console and LightDM - OK"

WARNING: qm snapshot 107 snap077 --description "2fa_smb.md=obs.ad; 2fa console and LightDM - OK"
